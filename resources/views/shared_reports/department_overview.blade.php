...
<div class="container-fluid px-3 px-md-4 mb-5 mt-4">
    ...
    <ul class="nav nav-tabs nav-tabs-scrollable mb-4 mt-3 border-bottom-2 pb-1">
        ...
        <li class="nav-item">
            <a class="nav-link active fw-bold text-primary border-bottom-0 shadow-sm" href="{{ URL::signedRoute('shared.reports.department', ['department' => $department]) }}">ภาพรวมหน่วยงาน</a>
        </li>
    </ul>
