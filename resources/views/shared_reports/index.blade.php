...
<div class="container-fluid px-3 px-md-4 mb-5">
    <ul class="nav nav-tabs nav-tabs-scrollable mb-4 mt-3 border-bottom-2 pb-1">
        <li class="nav-item">
            <a class="nav-link active fw-bold text-primary border-bottom-0 shadow-sm" href="{{ URL::signedRoute('shared.reports.index', ['department' => $department]) }}">รายบุคคล (สรุป 10 วัน)</a>
        </li>
        <li class="nav-item">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 mb-4">
        <div>
            <h2 class="text-primary fw-bold mb-1">📈 รายงานสรุปการอบรม (แผนก: {{ $department }})</h2>
            ...
            "buttons": [
                {
                    ...
                    title: 'รายงานสรุปการอบรมรายบุคคล_{{ $department }}',
