...
<div class="container mt-4 mb-5">
    ...
    <div class="mb-3 mx-auto" style="max-width: 800px;">
        <a href="{{ url('/summary') }}" class="btn btn-secondary shadow-sm">
            <i class="bi bi-arrow-left-circle me-1"></i> กลับหน้าตารางสรุป
        </a>
    </div>
    ...
    <div class="card shadow border-0 mx-auto" style="max-width: 800px; border-radius: 12px;">
        <div class="card-header bg-primary text-white text-center py-3" style="border-radius: 12px 12px 0 0;">
            <h4 class="mb-0">แบบฟอร์มบันทึกการประชุม</h4>
        </div>
        <div class="card-body p-4">
            ...
            <form action="{{ route('form.store') }}" method="POST">
                ...
                <div class="p-3 mb-4 bg-white border rounded shadow-sm">
                    <h6 class="text-primary mb-3">👤 ข้อมูลผู้เข้าร่วม (พิมพ์เพื่อค้นหา)</h6>
                    <div class="row">
                ...
                <div class="p-3 mb-4 bg-white border rounded shadow-sm">
                    <h6 class="text-primary mb-3">📅 วันเวลาที่จัดการประชุม</h6>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                ...
                <div class="p-3 mb-4 bg-white border rounded shadow-sm">
                    <h6 class="text-primary mb-3">📝 รายละเอียดการประชุม</h6>
                    <div class="mb-3">
                ...
                <div class="text-center mt-4">
                    <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow-sm">💾 บันทึกข้อมูลลงระบบ</button>
                </div>
            </form>
        </div>
    </div>
